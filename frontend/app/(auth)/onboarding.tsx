    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.stepContainer}>
          ...
          <ScrollView style={styles.scrollStepContent} showsVerticalScrollIndicator={false}>
            <Text style={styles.stepEmoji}>🎯</Text>
            <Text style={styles.stepTitle}>{t('whatIsYourGoal')}</Text>
            ...
            <View style={styles.goalOptions}>
              {diff <= 0 && (
                <>
                  <TouchableOpacity
                    style={[styles.goalCard, formData.goal === 'loseFast' && styles.goalCardSelected]}
                    onPress={() => setFormData({ ...formData, goal: 'loseFast' })}
                  >
                    <Text style={styles.goalEmoji}>🔥</Text>
                    <Text style={[styles.goalTitle, formData.goal === 'loseFast' && styles.goalTitleSelected]}>{t('loseFast')}</Text>
                    <Text style={styles.goalDesc}>{t('intensiveProgram')}</Text>
                  </TouchableOpacity>
                  ...
                  >
                    <Text style={styles.goalEmoji}>📉</Text>
                    <Text style={[styles.goalTitle, formData.goal === 'lose' && styles.goalTitleSelected]}>{t('loseWeight')}</Text>
                    <Text style={styles.goalDesc}>{t('balancedProgram')}</Text>
                  </TouchableOpacity>
                </>
              )}
              ...
              >
                ...
                <Text style={[styles.goalTitle, formData.goal === 'maintain' && styles.goalTitleSelected]}>{t('maintainWeight')}</Text>
              ...
              {diff >= 0 && (
                <>
                  ...
                  >
                    <Text style={styles.goalEmoji}>💪🏻</Text>
                    <Text style={[styles.goalTitle, formData.goal === 'gain' && styles.goalTitleSelected]}>{t('gainMuscle')}</Text>
                    <Text style={styles.goalDesc}>{t('balancedProgram')}</Text>
                  </TouchableOpacity>
                  
                  <TouchableOpacity
                    style={[styles.goalCard, formData.goal === 'gainFast' && styles.goalCardSelected]}
                    onPress={() => setFormData({ ...formData, goal: 'gainFast' })}
                  >
                    <Text style={styles.goalEmoji}>🏋🏻</Text>
                    <Text style={[styles.goalTitle, formData.goal === 'gainFast' && styles.goalTitleSelected]}>{t('gainFast')}</Text>
                    <Text style={styles.goalDesc}>{t('intensiveProgram')}</Text>
                  </TouchableOpacity>
                </>
              )}
